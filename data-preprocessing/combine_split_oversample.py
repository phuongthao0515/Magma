...
Pipeline:
1. Load all 3 app JSONs (with mark coordinates already injected)
2. Split balanced val: 50 per action per app = 600 val samples
3. Oversample rare actions in train: RIGHT_CLICK ×10, DOUBLE_CLICK ×10, TYPE ×5
4. Shuffle and save

Usage:
    python data-preprocessing/combine_split_oversample.py
"""
...
# ============ CONFIGURATION ============
INPUT_JSONS = {
    "word": "/home/thaole/thao_le/Magma/datasets/agentnet/word/word_final_yolo_ocr/word_som_with_marks_list.json",
    "excel": "/home/thaole/thao_le/Magma/datasets/agentnet/excel/excel_final_yolo_ocr/excel_som_with_marks_list.json",
    "powerpoint": "/home/thaole/thao_le/Magma/datasets/agentnet/powerpoint/powerpoint_final_yolo_ocr/powerpoint_som_with_marks_list.json",
}

OUTPUT_DIR = "/home/thaole/thao_le/Magma/datasets/agentnet/3_apps_combined"
TRAIN_OUTPUT = f"{OUTPUT_DIR}/train_3_apps_4actions.json"
VAL_OUTPUT = f"{OUTPUT_DIR}/val_3_apps_4actions.json"
