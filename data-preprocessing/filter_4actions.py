"""
Pre-filter mind2web JSONs to 4 target actions before SoM preprocessing.
...
Usage:
    python data-preprocessing/filter_4actions_mind2web.py --app excel
    python data-preprocessing/filter_4actions_mind2web.py --app powerpoint
    python data-preprocessing/filter_4actions_mind2web.py --app word
    python data-preprocessing/filter_4actions_mind2web.py --app all
"""
...
APP_CONFIGS = {
    "word": {
        "mind2web": "/home/thaole/thao_le/Magma/datasets/agentnet/word/word_mind2web_style.json",
        "jsonl": "/home/thaole/thao_le/Magma/datasets/agentnet/word/word_tasks.jsonl",
        "output": "/home/thaole/thao_le/Magma/datasets/agentnet/word/word_4actions.json",
        "filter_bad_steps": False,  # Word already filtered by generate_mind2web_from_jsonl.py
    },
    "excel": {
        ...
        "output": "/home/thaole/thao_le/Magma/datasets/agentnet/excel/excel_4actions.json",
    ...
    "powerpoint": {
        ...
        "output": "/home/thaole/thao_le/Magma/datasets/agentnet/powerpoint/powerpoint_4actions.json",
        "filter_bad_steps": True,  # Teammate's script didn't filter these
    },
}
...
def main():
    parser = argparse.ArgumentParser(description="Pre-filter mind2web to 4 actions")
    ...
    print("  to point to the *_4actions.json files, then run:")
