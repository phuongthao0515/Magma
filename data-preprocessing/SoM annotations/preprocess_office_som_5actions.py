...
Prerequisites:
  - Run filter_5actions.py first to filter to 5 actions (incl. TERMINATE)
    and remove redundant/incorrect steps
  - Pre-populate output folders with cached mark_metadata.json and images/
    from the 4-actions run (enables resume/cache: skips YOLO+OCR on cached
    images, only processes new TERMINATE images)

Usage:
    cd /home/thaole/thao_le/Magma
    python "data-preprocessing/SoM annotations/preprocess_office_som_5actions.py" --app word
    python "data-preprocessing/SoM annotations/preprocess_office_som_5actions.py" --app excel
    python "data-preprocessing/SoM annotations/preprocess_office_som_5actions.py" --app powerpoint
    python "data-preprocessing/SoM annotations/preprocess_office_som_5actions.py" --app all
"""
...
APP_CONFIGS = {
    "word": {
        ...
        "mind2web": "/home/thaole/thao_le/Magma/datasets/agentnet/word_5actions/word_5actions.json",
        "output_dir": "/home/thaole/thao_le/Magma/datasets/agentnet/word_5actions/word_final_yolo_ocr",
    },
    "excel": {
        "jsonl": "/home/thaole/thao_le/Magma/datasets/agentnet/excel/excel_windows_samples.jsonl",
        "mind2web": "/home/thaole/thao_le/Magma/datasets/agentnet/excel_5actions/excel_5actions.json",
        "output_dir": "/home/thaole/thao_le/Magma/datasets/agentnet/excel_5actions/excel_final_yolo_ocr",
    },
    "powerpoint": {
        "jsonl": "/home/thaole/thao_le/Magma/datasets/agentnet/powerpoint/powerpoint_windows_samples.jsonl",
        "mind2web": "/home/thaole/thao_le/Magma/datasets/agentnet/powerpoint_5actions/powerpoint_5actions.json",
        "output_dir": "/home/thaole/thao_le/Magma/datasets/agentnet/powerpoint_5actions/powerpoint_final_yolo_ocr",
    },
}
